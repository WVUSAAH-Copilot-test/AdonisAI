#!/usr/bin/env python3
"""
AdonisAI - Haupteinstiegspunkt mit SSL-Fix
Startet den Telegram Bot mit Workarounds für Firmennetzwerke
"""
...
# SSL-Warnungen global deaktivieren
urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

# SSL-Context global patchen
...
from src.bot.telegram_bot_ssl_fixed import create_bot
...
def main() -> None:
    ...
    # SSL-Patch Info
    logger.info("🔐 SSL-Verifizierung deaktiviert (Firmennetzwerk-Workaround)")
